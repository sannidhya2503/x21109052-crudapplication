...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\sanni\Downloads\djangocrudoperation\django-crud-operation\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\sanni\Downloads\djangocrudoperation\django-crud-operation\env\Scripts\deactivate.nu'
